...
public class DataBaseIdentityConnector
	...
	public DataBaseIdentityConnector() {
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.identityconnectors.framework.api.operations.GetApiOp#getObject(org.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.identityconnectors.framework.spi.operations.SyncOp#sync(org.
	 * identityconnectors.framework.common.objects.ObjectClass,
	 ...
	 * 
	 * @see
	 * org.identityconnectors.framework.spi.operations.SyncOp#getLatestSyncToken(org
	 * .identityconnectors.framework.common.objects.ObjectClass)
	 */
	...
	public Uid create(ObjectClass objectClass, Set<Attribute> createAttributes, OperationOptions options) {
		...
		Map<String, Object> row = DataBaseIdentityUtil.convertSetToMap(createAttributes);

		logger.ok("Create Request Attributes : " + createAttributes);
	...
	public Uid update(ObjectClass objectClass, Uid uid, Set<Attribute> replaceAttributes, OperationOptions options) {
		...
		logger.ok("update Operation Request Attributes: " + replaceAttributes);

		Map<String, Object> row = DataBaseIdentityUtil.convertSetToMap(replaceAttributes);
